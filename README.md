...
* [jamesdfinance-dev/lazaretto-mcp: Pre-install verification for npm packages, AI agent skills and MCP tools, matching exactly pinned lockfile dependencies against OSV and OpenSSF malicious package advisories, with an optional deterministic behavioral scan (credential theft, exfiltration, obfuscation, prompt injection, install-time droppers) reporting file and line evidence](https://github.com/jamesdfinance-dev/lazaretto-mcp)

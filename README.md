...
* [cpeoples/ansible-security-scanner: Static SAST scanner for Ansible playbooks, roles, collections, task files, vars, and inventories. Detects malicious code, RCE, command and template injection, hardcoded credentials, supply-chain risk, and unauthorized cloud access](https://github.com/cpeoples/ansible-security-scanner). Releases ship with SLSA Build Level 3 provenance, CycloneDX SBOMs, and Sigstore-signed artifacts. Outputs SARIF, GitLab SAST, JUnit, JSON, HTML, and Markdown.

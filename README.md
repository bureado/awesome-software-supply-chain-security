...
* [piiiico/proof-of-commitment: Behavioral supply chain risk scorer for npm, PyPI, Cargo, and Go packages that flags publisher concentration, release staleness, and download-to-publisher asymmetry as structural attack precursors. Available as zero-install CLI (`npx proof-of-commitment`), MCP server, GitHub Action, and REST API](https://github.com/piiiico/proof-of-commitment). Read: [Two Attacks, One Week — What Behavioral Scoring Caught and What It Missed](https://getcommit.dev/blog/two-attacks-one-week/)

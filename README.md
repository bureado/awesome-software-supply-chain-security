...
* [EverBright-IT/SBOM-Lens: A fast client-side viewer for SPDX and CycloneDX SBOMs that resolves cross-document cascades into a navigable tree, with VEX overlay (OpenVEX/CSAF 2.0), release diffing and NTIA/BSI TR-03183 profile checks](https://github.com/EverBright-IT/SBOM-Lens)

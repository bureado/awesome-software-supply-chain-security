...
* [AbelSolutions-io/nugate: Dependency age gate for NuGet that fails builds when resolved direct or transitive packages were published less than a configurable number of days ago, with allowlists, running locally and in CI without a proxy, server, or telemetry](https://github.com/AbelSolutions-io/nugate)

...
* [P-r-e-m-i-u-m/ai-change-passport: GitHub Action and CLI that creates signed provenance reports for AI-assisted pull requests, including sensitive file touches, dependency changes, workflow changes, test signals, risk scoring, and human approval guidance](https://github.com/P-r-e-m-i-u-m/ai-change-passport)

...
* [agentlaunchops-ai/gha-guard: Local CLI and VS Code scanner for GitHub Actions workflow supply-chain risks including unpinned actions, risky `pull_request_target`, broad permissions, missing timeouts, and shell injection patterns](https://github.com/agentlaunchops-ai/gha-guard)

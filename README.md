...
* [pangxueyuan2-creator/patchwitness: Independent verification and policy gate for AI-generated code changes; derives diffs from Git, loads policy from a trusted base revision, blocks protected CI/control-plane changes, runs repository checks, and emits offline-verifiable Change Passports with JSON, SARIF and GitHub Action support](https://github.com/pangxueyuan2-creator/patchwitness)

...
* [action-owasp-dependecy-track-check](https://github.com/Quobis/action-owasp-dependecy-track-check): GitHub Action that builds a CycloneDX SBOM for Node.js, Python, Go, Ruby, Java, .NET and PHP projects, converts it to v1.2 when necessary, and uplo...
* [Aikido Security](https://aikido.dev): Code-to-cloud security in one platform—scan, prioritize, and fix issues across the full stack.
* [Amazon Inspector SBOM Generator](https://docs.aws.amazon.com/inspector/latest/user/sbom-generator.html): Amazon Inspector SBOM Generator (inspector-sbomgen) outputs CycloneDX 1.4 or SPDX 2.3 SBOMs for archives, container images, directories, local syst...
* [apt2sbom](https://github.com/sbomtools/apt2sbom): Python tool that builds a Software Bill of Materials (SBOM) from APT and Python package information on Ubuntu systems, with CLI and HTTP interfaces.
* [ARIANNA](https://www.securitypattern.com/arianna-security-management-platform): SBOM, HBOM and vulnerability management platform for intelligent connect devices. Show compliance to regulations and standards and manage risk acro...
* [Arnica](https://www.arnica.io/): SaaS platform that automates software supply-chain security; offers free, always-up-to-date SBOM generation in CycloneDX format plus risk analysis ...
* [Arsenal](https://tools.deepbits.com/): Free online toolset that builds AI-powered SBOMs and SaaSBOMs for COTS, OSS, code repos and container images, then analyzes vulnerabilities, licens...
* [asdf-cyclonedx](https://github.com/xeedio/asdf-cyclonedx): asdf plugin that installs and manages CycloneDX CLI versions, enabling SBOM tooling in any asdf-managed environment.
* [Athena](https://github.com/anquanscan/sec-tools): Athena is a SaaS solution for medical device makers that overlays the product development lifecycle to address risks before devices go to market.
* [Beniva Software Bill of Materials (SBOM)](https://store.servicenow.com/sn_appstore_store.do#!/store/application/1f62663a1ba19dd06921a821604bcb98): Beniva SBOM allows you to consume CycloneDX SBOM and Vulnerability Exploitability eXchange (VEX) within the ServiceNow platform which increases vis...
* [Bitbucket Pipe for SBOM Generation](https://github.com/shiftleftcyber/syft-bitbucket-pipe): Integrate this Bitbucket Pipe into your CI/CD pipeline to automatically generate a Software Bill of Materials (SBOM) for any project.
* [Black Duck](https://github.com/blackducksoftware/detect): Black Duck is Synopsys’ SCA platform that generates CycloneDX/SPDX SBOMs, detects open-source vulnerabilities, and automates license and policy com...
* [BlackBerry Jarvis](https://blackberry.qnx.com/en/products/security/blackberry-jarvis): Software composition analysis (SCA) and security testing solution that detects and lists open-source software and licenses in embedded systems and ...
* [bogrod](https://github.com/productaize/bogrod): A command line tool to manage SBOM and VEX like source code and to distribute SBOMs to notaries.
* [BOM Repository Server](https://github.com/CycloneDX/cyclonedx-bom-repo-server): A lightweight repository server used to publish, manage, and distribute CycloneDX SBOMs.
* [bombon](https://github.com/nikstur/bombon): CLI and Nix library that generates CycloneDX v1.5 SBOMs for Nix packages, including build-time and vendored dependencies, compliant with BSI TR-031...
* [BOMnipotent](https://github.com/Weichwerke-Heidrich-Software/bomnipotent_doc): A server application for managing and distributing SBOMs and CSAF documents. Integrates with tools for vulnerability scanning.
* [BOMSkope](https://github.com/netskopeoss/BOMSkope): BOMSkope is a Software Bill of Materials manager designed to streamline the tracking of vendor components. It enables the identification and monito...
* [Boostsecurity.io](https://boostsecurity.io/): AppSec Testing and Application Security Posture Management (ASPM) platform allowing detection and management of code risk with runtime cloud contex...
* [build-info-go](https://github.com/jfrog/build-info-go): Open-source Go library and CLI that captures build metadata and outputs CycloneDX SBOMs for Java, Node.js, .NET, Go, Python and more.
* [Bytesafe](https://github.com/bitfront-se/bytesafe-ce): Bytesafe is a dependency firewall and SCA platform that blocks malicious packages, scans for vulnerabilities, enforces license policies, and genera...
* [CaPyCli - Clearing Automation for SW360](https://github.com/sw360/capycli): CaPyCli is an MIT-licensed Python CLI that generates, compares, merges and converts CycloneDX SBOMs for several language ecosystems and maps them t...
* [CAST Highlight](https://github.com/MichaelMULLER/highlight-scan-github-action): CAST Highlight automatically analyzes source code portfolios for open-source risks, cloud readiness, resiliency, green impact and technical debt, a...
* [CAST SBOM Manager](https://www.castsoftware.com/sbommanager): CAST SBOM Manager automates creation, customization and maintenance of SBOMs, adds vulnerability and license insights, and exports them in CycloneD...
* [CBOM Viewer](https://www.zurich.ibm.com/cbom/): A Web Service to visualize and explore the use of cryptography in software with Cryptography Bills of Materials (CBOM).
* [CBOMkit](https://github.com/IBM/cbomkit): CBOMkit is a toolset for generating, viewing, checking, and storing Cryptography Bills of Materials (CBOM).
* [CBOMkit-theia](https://github.com/IBM/cbomkit-theia): A tool that detects cryptographic assets in container images and directories, generating CBOMs.
* [cdx-central](https://github.com/nscuro/cdx-central): CLI utility that downloads public CycloneDX SBOMs from Maven Central for selected artifacts.
* [cdx-enrich](https://github.com/mtsfoni/cdx-enrich): Enriches a CycloneDX Software Bills of Material (SBOM) with predefined data.
* [cdx-vs-cdx](https://github.com/marcosanchotene/cdx-vs-cdx): GTK-style Python GUI that compares two CycloneDX JSON SBOMs, highlighting components unique to each file and those present in both.
* [ClickBOM](https://github.com/ClickHouse/ClickBOM): Downloads and merges SBOMs from various sources. Converts to CycloneDX and SPDX formats. Uploads to cloud storage and ClickHouse for analytics.
* [Codenotary vcn](https://github.com/codenotary/vcn): Protects an organization's software development pipeline from supply chain attacks. Codenotary natively supports CycloneDX SBOMs.
* [CodeSentry](https://www.grammatech.com): Software Composition Analysis (SCA) platform that leverages binary analysis to identify components, inherited risk, and communicates inventory thro...
* [Continuous Clearing](https://github.com/siemens/continuous-clearing): Scans third-party OSS components in NPM, NuGet, Maven, Python and Debian projects, generates CycloneDX SBOMs, then uploads them to SW360 and Fossol...
* [Conviso Platform](https://www.convisoappsec.com/conviso-platform): Conviso Platform includes an SCA engine that detects multi-language ecosystems, generates CycloneDX/SPDX SBOMs, enriches results with vulnerabiliti...
* [CVE Scan](https://theembeddedkit.io/cve-scan-linux-vulnerability-scanner/): Detect and mitigate vulnerabilities in embedded systems. Generate SBOMs, cross-reference public databases, integrate with CI pipelines, and use fil...
* [cve-bin-tool](https://github.com/intel/cve-bin-tool): Command-line scanner that identifies vulnerable components in binaries, accepts/generates SBOMs, and reports CVEs. Supports 400+ checkers for open ...
* [CxSCA](https://checkmarx.com/cxsca-open-source-scanning/): Software Composition Analysis (SCA) platform that identifies vulnerabilities, malicious code, and license risks in open-source libraries with explo...
* [Cyberwatch](https://cyberwatch.fr/en/): Cyberwatch Vulnerability Manager allows you to discover assets, scan and prioritize vulnerabilities, and fix them.
* [Debricked](https://github.com/debricked/cli): Debricked lets teams automatically find, fix and prevent open-source vulnerabilities, avoid non-compliant licences and pick healthier dependencies,...
* [Dependency-Track Jenkins Plugin](https://github.com/jenkinsci/dependency-track-plugin): Jenkins plugin that publishes CycloneDX Software Bill-of-Materials (SBOM) to the Dependency-Track platform for vulnerability analysis and policy ev...
* [Dependency-Track Maven Plugin](https://github.com/pmckeown/dependency-track-maven-plugin): Maven plugin that integrates with a Dependency-Track server to submit SBOMs and optionally fail execution when vulnerable dependencies are found
* [Distro2SBOM](https://github.com/anthonyharrison/distro2sbom): A command line tool which creates CycloneDX and SPDX SBOMs for an installed application or distribution (Debian, RPM, Windows and FreeBSD systems s...
* [docker-sbom-cli-plugin](https://github.com/docker/sbom-cli-plugin): Docker CLI plugin that generates Software Bills of Materials (SBOMs) for container images using Syft as the underlying scanner, with CycloneDX outp...
* [dtrack-audit](https://github.com/ozontech/dtrack-audit): Command-line client for OWASP Dependency-Track that publishes SBOMs and displays vulnerability information from the command line, designed for CI/C...
* [DtrackAuditor](https://github.com/thinksabin/DTrackAuditor): Python CLI tool to upload CycloneDX SBOMs to Dependency-Track, analyze vulnerabilities, enforce policy, and fail CI builds based on thresholds.
* [Eclipse SW360 Antenna](https://github.com/eclipse-archived/antenna): Archived tool that scanned project artifacts, downloaded sources for dependencies, validated licenses, and generated license compliance documentation
* [Evo by Snyk](https://evo.ai.snyk.io): Evo helps you generate an AI-BOM including models, datasets, agents, tools, and MCPs within your Python projects.
* [EXPLIoT IoT Security Assessment Framework](https://gitlab.com/expliot_framework/expliot): EXPLIoT is an AGPLv3 Python framework and CLI for assessing and exploiting IoT devices; it offers 140+ plug-ins and can generate CycloneDX SBOMs fr...
* [Flawnter](https://www.flawnter.com/): Flawnter is a zero-trust static, dynamic and composition analysis platform that detects code flaws, vulnerabilities and license risks, and generate...
* [Fortify on Demand](https://github.com/fortify/github-action): SaaS application-security testing platform offering SAST, DAST and SCA. Produces and consumes CycloneDX SBOMs to secure the software supply chain a...
* [Fortify Software Security Center](https://github.com/fortify/fortify-ssc-parser-generic-cyclonedx): Open-source CycloneDX parser plugin for Fortify SSC that imports SBOMs, correlates components with known vulnerabilities and licenses, and displays...
* [Fortress Asset 2 Vendor](https://assettovendor.com): Comprehensive cyber supply chain risk management platform that ingests, analyzes and securely shares SBOMs, HBOMs and other supply chain attestatio...
* [Gemnasium](https://gitlab.com/gitlab-org/security-products/analyzers/gemnasium): Dependency scanning analyzer that uses the GitLab Advisory Database to detect vulnerabilities in project dependencies and generates CycloneDX SBOMs.
* [Generate SBoM for Elixir project](https://github.com/red-shirts/action-mix-sbom): GitHub Action to generate CycloneDX Software Bill-of-Materials (SBOM) for Erlang/Elixir Mix projects
* [Go Sonatypes](https://github.com/sonatype-nexus-community/go-sona-types): Common utility packages for working with OSS Index, Nexus IQ Server, CycloneDX SBOMs or getting a user-agent
* [gobom](https://github.com/mattermost/gobom): An extensible CycloneDX BOM generator and Dependency-Track API client written in Go; supports Go, npm, CocoaPods and Gradle projects and uploads SB...
* [Heimdall](https://www.medcrypt.com/solutions/helm): Automatically extract or manually upload your Software Bill of Materials (SBOM), and Heimdall will, on a continual basis, identify known vulnerabil...
* [Hermeto](https://github.com/hermetoproject/hermeto): Hermeto is a CLI tool that pre-fetches your project's dependencies, which enables network-isolated builds, which enables the production of high-acc...
* [Ion Channel Platform](https://www.exiger.com/products/ion-channel/): Risk management platform that enables analysis, exchange and continuous monitoring of Software Bills of Materials (SBOMs) to actively manage third ...
* [ittosai](https://github.com/devops-kung-fu/ittosai): ittosai is a CycloneDX SBOM vulnerability analyzer that analyzes SBOMs every time a developer commits code to a repository.
* [jbom](https://github.com/eclipse/jbom): jbom generates runtime and static CycloneDX SBOMs for local or remote Java applications and archives.
* [JDisc Discovery](https://www.jdisc.com/): Network discovery and IT inventory tool that can discover CycloneDX SBOMs on enterprise assets and ingest component inventory into the platform.
* [Jetstack Secure](https://github.com/jetstack/jetstack-secure): Manages machine identities across Cloud Native Kubernetes and OpenShift environments, providing a detailed view of enterprise security posture for ...
* [kbom - Kubernetes Bill of Materials powered by KSOC](https://github.com/rad-security/kbom): kbom is an open-source CLI tool from KSOC, written in Go, that generates detailed CycloneDX SBOMs for Kubernetes clusters, including nodes, control...
* [Keysight IoT Security Assessment](https://www.keysight.com/be/en/products/network-security/iot-security-assessment.html): Automated firmware analysis platform that generates SBOMs and identifies vulnerabilities, misconfigurations, hardcoded credentials, weak cryptograp...
* [Kondukto](https://github.com/kondukto-io/kdt): Application Security Orchestration and Correlation platform that generates and consumes CycloneDX or SPDX SBOMs, correlates vulnerability scanner f...
* [Lagoon Insights Handler](https://github.com/uselagoon/insights-handler): Component that processes CycloneDX SBOMs and container image metadata for Lagoon environments, with vulnerability analysis via Trivy integration an...
* [Lib4sbom](https://github.com/anthonyharrison/lib4sbom): Python library that parses, converts and generates SBOMs in CycloneDX and SPDX formats, allowing JSON, Tag, YAML and XML serialization and programm...
* [License Scanner](https://github.com/CycloneDX/license-scanner): license-scanner is an Apache-2.0 Go library and CLI that detects SPDX-style licenses and legal terms in source files and outputs CycloneDX v1.4 SBO...
* [LicenseComplianceTool](https://github.com/medavis-gmbh/LicenseComplianceTool): Creates license manifests from CycloneDX SBOMs. Provides a Jenkins build step and CLI to list third-party components, their licenses, and download ...
* [macaron](https://github.com/oracle/macaron): Macaron is a supply chain security analysis tool and policy engine that checks conformance to frameworks such as SLSA, integrating CycloneDX SBOM g...
* [mdbom](https://github.com/HaRo87/mdbom): A simple command line tool to transform CycloneDX SBoMs to markdown.
* [MedScan](https://www.medsec.com/): Consumes SBOMs to help hospitals manage medical device assets, providing vulnerability and resource analysis for compliance and risk management.
* [Meta Package Manager](https://github.com/kdeldycke/meta-package-manager): Export a SBOM of all packages installed on a Linux, macOS or Windows system.
* [meta-dependencytrack](https://github.com/bgnetworks/meta-dependencytrack): meta-dependencytrack is a Yocto meta-layer which produces a CycloneDX Software Bill of Materials (aka SBOM) from your root filesystem and then uplo...
* [Meterian BOSS scanner](https://github.com/MeterianHQ/meterian-github-action): Software composition analysis that inventories codebases and produces CycloneDX SBOMs while detecting security and licence risks across 12+ ecosyst...
* [MLBOMdoc](https://github.com/anthonyharrison/mlbomdoc): A command line tool which produces a human-readable representation of a CycloneDX ML Bill of Materials (MLBOM). Output formats include PDF and Mark...
* [Neo4Cyclone](https://github.com/javixeneize/neo4cyclone): Neo4Cyclone is a tool that allows you to visualise your SBOMs using Neo4J.
* [NetRise Platform](https://github.com/netriseinc): The NetRise Platform generates SBOMs for binary code and post-build artifacts. It can ingest and analyze 3rd party SBOMs and provide guidance on ri...
* [Nexus IQ](https://www.sonatype.com/product-nexus-lifecycle): Software Composition Analysis (SCA) platform that can consume, analyze, and produce CycloneDX SBOMs
* [Nexus Lifecycle Jenkins Plugin](https://github.com/jenkinsci/nexus-platform-plugin): Publishes CycloneDX SBOMs to Nexus IQ for per-build analysis, result visualization, and policy evaluation
* [nim_lk](https://git.sr.ht/~ehmry/nim_lk): Create and update SBOMs for the Nim programing language. Includes a translation module for the Nimble package manager as well as a Nix expression f...
* [NowSecure Platform](https://www.nowsecure.com/products/nowsecure-platform/): Mobile application security testing solution that automates static, dynamic and interactive testing, with SBOM capabilities through GitHub integrat...
* [Ochrona CLI](https://github.com/ochronasec/ochrona-cli): A command line tool for detecting vulnerabilities in Python dependencies and doing safe package installs. Outputs CycloneDX SBOMs and supports poli...
* [Oligo Runtime SBOM](https://www.oligo.security/): Oligo Security delivers instant insights into actively executed libraries, assessing open source risks and confirming exploitability. It enables Cy...
* [ONEKEY firmware analysis platform](https://onekey.com/): Cloud-based platform that automatically extracts firmware images, enumerates components, and produces CycloneDX SBOM and vulnerability reports.
* [OpenRewrite](https://github.com/openrewrite/rewrite): Open-source automated refactoring ecosystem for code transformation, security remediation, and dependency management through reusable recipes and b...
* [OSS Inventory](https://github.com/thspinto/oss_inventory): A web application for importing, storing, and visualizing CycloneDX SBOMs, allowing organizations to track software components across projects.
* [OWASP AIBOM Generator](https://github.com/GenAI-Security-Project/aibom-generator): Generate AIBOM (AI SBOM, AI/ML-BOM) in CycloneDX format for models on Hugging Face.
* [Parlay](https://github.com/snyk/parlay): Parlay is an Apache-licensed CLI written in Go that takes CycloneDX 1.4 JSON/XML or SPDX 2.3 SBOMs and enriches them with licence, vulnerability, m...
* [Prisma Cloud](https://www.paloaltonetworks.com/prisma/cloud): Unified cloud-native application protection platform that scans code, pipelines, infrastructure and runtime to generate CycloneDX SBOMs, analyze vu...
* [ProCap360](https://github.com/ProCap360): An advanced SBOM, RBOM and AIBOM  cybersecurity risk management tool using novel knowledge graph technology to enhance software supply chain securi...
* [Product Security Hub (PSH)](https://www.ProductSecurityHub.com/): Cloud-based tool to import, export, view, create, edit, and transform CycloneDX SBOMs and human-readable SBOMs, as well as manage VEX data.
* [Project Piper](https://github.com/SAP/jenkins-library): Project Piper is an open-source Jenkins shared library and CLI that automates SAP-centric CI/CD pipelines and can generate CycloneDX SBOMs for Mave...
* [PulseUno Plugin for Dimensions CM](https://www.microfocus.com/en-us/products/dimensions-cm): PulseUno enables development teams to continually build and inspect the health and quality of code using plugins such as CycloneDX. Teams can use t...
* [Qinsight Atlas](https://qinsight.com): Cryptographic posture management platform that discovers, inventories and analyzes cryptographic assets across environments, can import/export Cycl...
* [RapidFort](https://github.com/rapidfort/community-images): Container-optimization platform that scans, profiles and hardens images, generates SBOMs, converts to CycloneDX/SPDX, and exports VEX to prioritize...
* [ReARM](https://github.com/relizaio/rearm): ReARM is a system to store, organize and manage SBOMs / xBOMs with Component and Product releases.
* [Rebom](https://github.com/relizaio/rebom): Open source catalog for storing, managing, and distributing CycloneDX Software Bills of Materials (SBOMs) in JSON format, with features for validat...
* [Reliza Hub](https://relizahub.com/): Publishes and ingests SBOMs for metadata management, compliance, and distribution. Supports CycloneDX and SPDX standards for software supply chain ...
* [Retire.js](https://github.com/RetireJS/retire.js): Scanner that detects the use of JavaScript libraries with known vulnerabilities in web and Node.js applications and can generate CycloneDX-format S...
* [Rollup Plugin SBOM](https://github.com/janbiasi/rollup-plugin-sbom): Creates CycloneDX SBOMs for frontend Javascript apps bundled with rollup or vite.
* [RunSafe C/C++ Build-time SBOM Generator](https://runsafesecurity.com/c-c-plus-plus-sbom/): Generates a C/C++ SBOM at build-time without a package manager, working across build environments and reporting on all library dependencies.
* [Salus](https://github.com/coinbase/salus): Salus is a tool for coordinating the execution of security scanners. Salus can generate CycloneDX SBOMs from many language ecosystems.
* [SBOM Assembler](https://github.com/interlynk-io/sbomasm): sbomasm is a command-line tool that assembles product SBOMs from component SBOMs, supporting CycloneDX and SPDX formats for streamlined management ...
* [SBOM Benchmark](https://github.com/interlynk-io/sbombenchmark.dev): SBOM Benchmark is an Apache-licensed web application that scores CycloneDX 1.4/1.5 and SPDX SBOMs for quality and compliance, generating shareable ...
* [SBOM Explorer](https://github.com/interlynk-io/sbomex): sbomex is a command line utility to help query and pull from Interlynk's public SBOM repository.
* [SBOM Grep](https://github.com/interlynk-io/sbomgr): Command-line utility (`sbomgr`) that performs grep-style searches across SBOMs by name, checksum, CPE, and PURL.
* [SBOM Observer](https://github.com/marketplace/actions/sbom-observer-scan-and-upload): SBOM Observer provides a comprehensive SBOM workflow to help you manage your software supply chain. Leverage the powerful combination of the Policy...
* [SBOM Utility (sbom-utility)](https://github.com/CycloneDX/sbom-utility): Go-based CLI and API to validate, query, trim and patch CycloneDX or SPDX BOMs, report on components, licences and vulnerabilities, and handle all ...
* [SBOM Vendor Management](https://www.settletop.com/sbom): Manage, assess, store and monitor all your vendor’s SBOMs in one secure, centralized dashboard to improve supply chain security.
* [sbom-action](https://github.com/thepwagner/sbom-action): GitHub Action that fetches and diffs CycloneDX SBOMs for container images, posting comments or opening pull requests when package or vulnerability ...
* [SBOM-HQ](https://sbomhq.com/): Analyzes SBOMs for vulnerabilities, licenses, and component lifecycle. Offers advanced built-in and customizable reports, alerting, and fine-graine...
* [SBOM-Manager](https://github.com/anthonyharrison/sbom-manager): SBOM-Manager is an open-source Python CLI that stores, queries, and scans CycloneDX 1.4/1.5 and SPDX 2.3 SBOMs via a local repository to support au...
* [sbom-rs](https://github.com/psastras/sbom-rs): A group of Rust projects for interacting with and producing software bill of materials (SBOMs).
* [sbom-swissarmy-bitbucket-pipe](https://github.com/shiftleftcyber/sbom-utilities-pipe): A Bitbucket Pipe containing a collection of open source tools to perform additional analysis on a CycloneDX or SPDX SBOM.
* [sbom-validator](https://github.com/shiftleftcyber/sbom-validator): A lightweight Go library for validating Software Bill of Materials (SBOM) against industry-standard specifications.
* [SBOM.sh](https://github.com/codenotary/sbom.sh-container): SBOM.sh is a free service to store, visualize and globally share CycloneDX SBOM files by simply using HTTP requests or curl.
* [SBOM2doc](https://github.com/anthonyharrison/sbom2doc): SBOM2doc converts CycloneDX or SPDX SBOMs into human-readable reports in PDF, Markdown, HTML, Excel or console formats via a cross-platform Python ...
* [SBOM2dot](https://github.com/anthonyharrison/sbom2dot): CLI that reads CycloneDX or SPDX SBOMs and emits a GraphViz-compatible DOT file so you can visualise component and dependency relationships.
* [SBOM4Files](https://github.com/anthonyharrison/sbom4files): Command-line tool that scans a directory and generates CycloneDX (JSON) or SPDX SBOMs for its files.
* [SBOM4Python](https://github.com/anthonyharrison/sbom4python): CLI utility that produces CycloneDX or SPDX SBOMs for installed Python modules or requirements files, identifying dependencies and their licenses, ...
* [SBOM4Rust](https://github.com/anthonyharrison/sbom4rust): CLI that reads Cargo.lock and authors CycloneDX v1.6 or SPDX SBOMs for Rust projects.
* [SBOMAudit](https://github.com/anthonyharrison/sbomaudit): SBOMAudit is a command-line utility that audits CycloneDX or SPDX SBOMs against NTIA minimum requirements, license policies, allow/deny lists, and ...
* [SBOMcenter](https://sbomcenter.io): SBOMcenter.io is a free service to get insights into the ingredients of your software for free and without any software.
* [SBOMDiff](https://github.com/anthonyharrison/sbomdiff): SBOMDiff is an Apache-2.0 CLI that compares two SBOM files (CycloneDX 1.4 or SPDX 2.3), highlighting package additions, removals, version or licens...
* [SBOMHub CLI](https://github.com/youichi-uda/sbomhub-cli): CLI tool that wraps Syft, Trivy, and cdxgen to generate SBOMs and upload them to SBOMHub with vulnerability scanning support.
* [SBOMMerge](https://github.com/anthonyharrison/sbommerge): Command-line utility that merges two SBOM files, supporting CycloneDX and SPDX inputs and outputs in tag, JSON or YAML formats.
* [SBOMTrend](https://github.com/anthonyharrison/sbomtrend): A command line tool which analyses a set of SBOMs to identify license and version changes in components.
* [sca-codeinsight-reports-cyclonedx](https://github.com/flexera-public/sca-codeinsight-reports-cyclonedx): Generates CycloneDX SBOM reports (XML and JSON) for projects scanned in Flexera Code Insight.
* [SecObserve](https://github.com/SecObserve/SecObserve): Open-source platform that aggregates findings and CycloneDX SBOMs from many scanners, lets teams assess security and license risks, and reports res...
* [SnykVulnCheck](https://github.com/Andrii-Grytsenko-OWASP/SnykVulnCheck): Command-line tool that analyzes CycloneDX SBOMs and evaluates components for known vulnerabilities by querying the public Snyk Vulnerability Databa...
* [Sonar Cryptography Plugin](https://github.com/IBM/sonar-cryptography): A SonarQube Plugin that detects cryptographic assets in source code and generates CBOM.
* [SonarQube](https://github.com/SonarSource/sonarqube): SonarQube allows developers and development teams to write clean code and remediate existing code organically, so they can focus on the work they l...
* [SonarQube Advanced Security](https://sonarsource.com/solutions/security): Secure your entire codebase—first-party, third-party, and everything in between. Seamlessly integrated into your workflow, SonarQube detects and fi...
* [Sonatype Lift](https://lift.sonatype.com/): Cloud-native, collaborative code analysis platform that analyzes pull requests to find and fix security, performance, reliability, and style issues...
* [Spack](https://github.com/spack/spack-sbom): HPC package manager for Linux and macOS; the spack-sbom plug-in exports CycloneDX SBOMs for any concretized spec.
* [spdxcyclone](https://github.com/spdx/cdx2spdx): Java utility that converts Software Bill of Materials (SBOM) documents from CycloneDX format to SPDX format, supporting multiple serialization opti...
* [Spectra Assure](https://github.com/reversinglabs/spectra-assure-sdk): Spectra Assure scans binary software packages, container images, and VM disk images to detect malware, tampering, vulnerabilities, and other exposu...
* [SRC:CLR SBOM Generator](https://github.com/veracode/srcclr_sbom_gen): Generates a Software Bill of Materials in CycloneDX JSON Format from Veracode SCA Agent results
* [StackAware](https://stackaware.com/): StackAware is a SaaS platform for managing CycloneDX 1.4/1.5 and SPDX SBOMs, enriching them with VEX data, and securely distributing both SBOMs and...
* [Sunshine](https://github.com/CycloneDX/Sunshine/): Open-source SBOM visualization tool. Converts CycloneDX JSON into interactive charts and tables for components, dependencies, vulnerabilities, and ...
* [Surfactant](https://github.com/LLNL/Surfactant): A modular framework for extracting file information and relationships for filesystems, with an SBOM as the primary output.
* [swift-package-sbom-generator](https://github.com/mattt/swift-package-sbom): A software bill of materials (SBOM) generator for Swift packages
* [SwiftBOM](https://github.com/CERTCC/SBOM): Generates SBOMs for demo and PoC purposes. Supports output in CycloneDX, SPDX, and SWID formats. Visualizes SBOMs as tree graphs.
* [Tally](https://github.com/jetstack/tally): Command-line tool that adds OpenSSF Scorecard security posture scores to packages listed in CycloneDX SBOMs.
* [Threatrix](https://threatrix.io): Threatrix CodeCertify platform provides a solution for producing a comprehensive and accurate, singular, CycloneDX bill of materials from multiple ...
* [TrustSource](https://github.com/trustsource): SaaS platform for implementing and maintaining open source compliance that imports CycloneDX SBOMs, analyzes them for licenses and vulnerabilities,...
* [ts-scan](https://github.com/TrustSource/ts-scan): Multi ecosystem SCA cli tool supporting SBOM generation, decoration and analysis for licenses, vulnerabilities, known code snippets and malware.
* [Valaa Stack](https://github.com/valaatech/kernel): SBoMDoc is a VDoc extension which uses CycloneDX namespaces and can emit BOM documents in various formats
* [Valint](https://github.com/scribe-security/gatekeeper-valint): CLI and CI/CD tool for generating CycloneDX SBOMs, signing and verifying supply-chain evidence, enforcing policy, and tracking vulnerabilities acro...
* [Value Stream Management (VSM)](https://www.leanix.net/en/products/value-stream-management): SaaS catalog that ingests CycloneDX SBOMs via REST API, indexes them by team and product, and surfaces vulnerabilities, licenses and component age ...
* [vex2pdf](https://gitlab.com/jurassicLizard/vex2pdf): A Rust command-line tool and library to convert CycloneDX (VEX/VDR/SBOM) JSON or XML documents to PDF reports with support for vulnerability analys...
* [Vexy](https://github.com/madpah/vexy): Generate VEX (Vulnerability Exploitability Exchange) CycloneDX documents.
* [Vigiles](https://github.com/TimesysGit/vigiles-cli): Vulnerability monitoring and remediation suite that imports, generates, converts, and analyses CycloneDX or SPDX SBOMs with curated CVE feeds and b...
* [vsm-sbom-booster](https://github.com/leanix/vsm-sbom-booster): CLI and Docker-based tool that scans Git providers, runs ORT, generates CycloneDX SBOMs centrally, and uploads them to LeanIX VSM to speed onboarding.
* [Vulert Vulnerability Scanner](https://vulert.com/abom): Web SCA service that analyzes CycloneDX or SPDX SBOMs (or lockfiles) to flag open-source vulnerabilities and license issues, sending real-time aler...
* [Vulnerabilities.io](https://www.vulnerabilities.io): Generates CycloneDX Software Bill of Materials (SBOM) and visualizations for an organization's codebase through integrations with source control sy...
* [WpBom](https://github.com/sepbit/wpbom): WordPress plugin that generates CycloneDX SBOMs for installed plugins and themes, and can automatically submit them to OWASP Dependency-Track for v...
* [Xygeni Software Supply-Chain Security](https://github.com/xygeni/xygeni-action): Supply-chain security platform and CLI that generates CycloneDX SBOMs, analyses vulnerabilities and misconfigurations, enforces policy in CI/CD, an...
* [yasca (Yet Another SCA tool)](https://github.com/javixeneize/zasca): Yasca (Yet Another SCA tool) is an open-source Python utility and GitHub Action that scans Maven projects against GitHub Security Advisories, detec...

* The CycloneDX project also provides official SBOM generators and libraries for many ecosystems:
  * [CycloneDX .NET Generate SBOM](https://github.com/CycloneDX/gh-dotnet-generate-sbom): GitHub Action to create a CycloneDX Software Bill-of-Materials (SBOM) for .NET projects supporting multiple project formats and recursive analysis
  * [CycloneDX BOM Studio](https://github.com/CycloneDX/cyclonedx-bom-studio): A visual editor for creating and managing CycloneDX Bills of Materials. BOM Studio lets you create, edit, validate, and export CycloneDX BOMs throu...
  * [CycloneDX Core for Java](https://github.com/CycloneDX/cyclonedx-core-java): Java library for creating, parsing, and validating CycloneDX SBOMs.
  * [CycloneDX for .NET](https://github.com/CycloneDX/cyclonedx-dotnet): Generates CycloneDX Software Bill of Materials (SBOM) from .NET projects.
  * [CycloneDX for Bower](https://github.com/hanstdam/cdx-bower-bom): Creates CycloneDX Software Bill of Materials (SBOM) from JavaScript projects that manage dependencies with Bower.
  * [CycloneDX for Cocoapods](https://github.com/CycloneDX/cyclonedx-cocoapods): Creates CycloneDX SBOMs for Objective-C and Swift projects that use CocoaPods.
  * [CycloneDX for Conan1](https://github.com/CycloneDX/cyclonedx-conan): Creates CycloneDX Software Bill of Materials (SBOM) for C/C++ projects using Conan1 (note: considered deprecated)
  * [CycloneDX for Conan2](https://github.com/conan-io/conan-extensions): Creates CycloneDX Software Bill of Materials (SBOM) for C/C++ projects using Conan2
  * [CycloneDX for Erlang/Elixir (Mix)](https://github.com/voltone/sbom): Mix task that generates CycloneDX SBOMs for Erlang/Elixir projects, exporting XML or JSON and supporting multiple CycloneDX schema versions.
  * [CycloneDX for Erlang/Elixir (Rebar3)](https://github.com/voltone/rebar3_sbom): Rebar3 plug-in that generates CycloneDX SBOMs for Erlang/Elixir projects, exporting XML or JSON and supporting CycloneDX v1.4.
  * [CycloneDX for esbuild](https://github.com/CycloneDX/cyclonedx-esbuild): CLI and plugin that generates CycloneDX Software Bill of Materials (SBOM) for during the esbuild process.
  * [CycloneDX for Fortran Package Manager](https://github.com/coderpatros/cyclonedx-fortran-fpm): Generates CycloneDX Software Bill of Materials (SBOM) for Fortran fpm projects.
  * [CycloneDX for Go](https://github.com/ozonru/cyclonedx-go): Command-line utility and Go library that generates CycloneDX SBOMs from Go module projects for supply-chain transparency.
  * [CycloneDX for Go modules](https://github.com/CycloneDX/cyclonedx-gomod): Command-line utility and Go library that generates CycloneDX SBOMs from Go modules, binaries and applications.
  * [CycloneDX for Gradle](https://github.com/CycloneDX/cyclonedx-gradle-plugin): Gradle plugin that generates CycloneDX SBOMs (XML or JSON) for all dependencies in Java-based builds.
  * [CycloneDX for Maven](https://github.com/CycloneDX/cyclonedx-maven-plugin): Apache Maven plugin that automatically generates CycloneDX SBOMs (JSON or XML) for Java projects and can attach vulnerability disclosure information.
  * [CycloneDX for Node.js](https://github.com/CycloneDX/cyclonedx-node-module): This is a so-called meta-package, it does not ship any own functionality, but it is a collection of optional dependencies with one purpose in commo...
  * [CycloneDX for NPM](https://github.com/CycloneDX/cyclonedx-node-npm): Create CycloneDX Software Bill of Materials (SBOM) from npm projects.
  * [CycloneDX for PHP Composer](https://github.com/CycloneDX/cyclonedx-php-composer): Create CycloneDX Software Bill of Materials (SBOM) from PHP Composer projects.
  * [CycloneDX for Python](https://github.com/CycloneDX/cyclonedx-python): Generates CycloneDX SBOMs from Python (virtual) environments, requirement files, and manifests (Poetry, PipEnv, etc)
  * [CycloneDX for Ruby Gems](https://github.com/CycloneDX/cyclonedx-ruby-gem): Command-line utility and Ruby library that generates CycloneDX SBOMs for Ruby projects by analysing Gem dependencies.
  * [CycloneDX for Rust Cargo](https://github.com/CycloneDX/cyclonedx-rust-cargo): Cargo sub-command and CLI library that generates CycloneDX SBOMs for Rust projects, aggregating all crate dependencies and outputting JSON or XML.
  * [CycloneDX for SBT (Scala)](https://github.com/sbt/sbt-sbom): SBT plugin that generates CycloneDX SBOMs (JSON or XML) for Scala/Java builds, supporting schema v1.6 and integrating smoothly with Dependency-Track.
  * [CycloneDX for Yarn](https://github.com/CycloneDX/cyclonedx-node-yarn): Create CycloneDX Software Bill of Materials (SBOM) from yarn projects.
  * [CycloneDX GoMod Generate SBOM](https://github.com/CycloneDX/gh-gomod-generate-sbom): GitHub action which generates CycloneDX SBOMs from Go modules, providing integration into CI/CD workflows for Go projects.
  * [CycloneDX JavaScript Library](https://github.com/CycloneDX/cyclonedx-javascript-library): Core functionality of CycloneDX for JavaScript (Node.js or Web Browser) written in TypeScript.
  * [CycloneDX Libraries for .NET](https://github.com/CycloneDX/cyclonedx-dotnet-library): .NET libraries to consume and produce CycloneDX Software Bill of Materials (SBOM).
  * [CycloneDX library for Go](https://github.com/CycloneDX/cyclonedx-go): Go library that can parse, create and serialize CycloneDX Software Bill of Materials (SBOM) in JSON or XML.
  * [CycloneDX MSBuild Task](https://github.com/coderpatros/cyclonedx-dotnet-msbuild): Generates CycloneDX Software Bill of Materials (SBOM) for .NET projects by integrating into the MSBuild process.
  * [CycloneDX Node.js Generate SBOM](https://github.com/CycloneDX/gh-node-module-generatebom): GitHub Action to create a CycloneDX Software Bill-of-Materials (SBOM) for Node.js projects containing an aggregate of all project dependencies. (no...
  * [CycloneDX Perl Library](https://github.com/giterlizzi/perl-SBOM-CycloneDX): Perl library for generating CycloneDX BOMs.
  * [CycloneDX PHP Composer Generate SBOM](https://github.com/CycloneDX/gh-php-composer-generate-sbom): GitHub Action to create a CycloneDX Software Bill-of-Materials (SBOM) for PHP Composer projects (note: considered deprecated)
  * [CycloneDX PHP Library](https://github.com/CycloneDX/cyclonedx-php-library): PHP library that supplies data-models, serializers, validators and utilities for creating, parsing and validating CycloneDX BOM documents in JSON a...
  * [CycloneDX Python Generate SBOM](https://github.com/CycloneDX/gh-python-generate-sbom): GitHub Action to create a CycloneDX Software Bill-of-Materials (SBOM) for Python projects from requirements files (note: considered deprecated)
  * [CycloneDX Python Library](https://github.com/CycloneDX/cyclonedx-python-lib): This Python package provides data models, validators and more, to help you create/render/read CycloneDX documents.
  * [CycloneDX Rust](https://github.com/doddi/cyclonedx-rust): Simple Rust library to encode and decode CycloneDX BOMs.
  * [CycloneDX Web Tool](https://github.com/CycloneDX/cyclonedx-web-tool): Web-based tool for validating, viewing, and converting CycloneDX SBOMs. Supports XML/JSON, and conversion between CycloneDX and SPDX formats.
  * [CycloneDX-Buildroot](https://github.com/cyclonedx/cyclonedx-buildroot): Python application that generates CycloneDX Software Bill of Materials (SBOM) for Buildroot-generated projects and other projects with CSV manifest...
  * [cyclonedx-editor-validator](https://github.com/Festo-se/cyclonedx-editor-validator): Command-line utility to create, merge, edit and validate CycloneDX SBOMs and VEX files for automated CI/CD workflows.
  * [cyclonedx-enrich](https://github.com/fnxpt/cyclonedx-enrich): Enrich CycloneDX SBOM files by applying enrichers to improve data quality, including licenses, hashes, properties, and references.
  * [cyclonedx-merge](https://github.com/fnxpt/cyclonedx-merge): Tool to merge CycloneDX files (JSON/XML) with support for normal, flat, and smart merge modes.
  * [cyclonedx-npm-pipe](https://github.com/ccideas/cyclonedx-npm-pipe): Bitbucket Pipe that packages cdxgen in a Docker image to generate CycloneDX v1.6 SBOMs for Node.js/npm projects in CI pipelines.
  * [cyclonedx_deps_to_mermaid.xsl](https://gist.github.com/jkowalleck/a0f874ee0a8af9a56a0e887631fc53d1): Extensible Stylesheet Language Transformations (XSLT) to translate CycloneDX dependency graph to mermaid chart.

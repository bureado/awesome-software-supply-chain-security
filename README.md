...
* [piiiico/proof-of-commitment: Behavioral risk scoring for npm, PyPI, Cargo, and Go packages — surfaces publisher concentration, release consistency, and maintenance patterns that predict supply chain attacks. CLI, MCP server, GitHub Action, and IDE hooks for Cursor and Claude Code](https://github.com/piiiico/proof-of-commitment)

...
* [sktelecom/sbom-tools (BomLens): local-first SBOM generator and open source risk assessor producing CycloneDX SBOMs, AI ML-BOMs with G7 conformance checks, NOTICE files, and license/security risk reports from source, containers, binaries, firmware, AI models and ingested SBOMs. CLI, web UI and desktop app](https://github.com/sktelecom/sbom-tools) from [SK Telecom](https://www.sktelecom.com/)

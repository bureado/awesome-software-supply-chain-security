...
* Several [pre-commit](https://pre-commit.com/hooks.html) hooks allow vulnerability checking right before dependency ingestion time into the codebase
  * e.g., [pyupio/safety: Safety checks your installed dependencies for known security vulnerabilities](https://github.com/pyupio/safety)
    * Or [npm-audit](https://docs.npmjs.com/cli/v8/commands/npm-audit)
      ...
      * And [Flo5k5/supply-chain-scan: Zero-dependency CLI (and Claude Code plugin) that scans npm/PyPI/Docker/Go/Rust/NuGet lockfiles for known-malicious packages (OSV MAL- feed) and CVEs, flags freshly-published (zero-hour) dependencies, checks release-cooldown/digest pinning, and flags install-time code-execution vectors (build manifests, oversized undeclared root JS, auto-exec agent/IDE configs)](https://github.com/Flo5k5/supply-chain-scan)

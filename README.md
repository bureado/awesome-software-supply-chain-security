...
* [sjh9714/mergewarden: Checkout-free policy gate for AI-agent pull requests that reports declared-scope escapes, GitHub Actions permission escalation, unpinned actions, and agent-control-plane drift with deterministic evidence, without executing PR code or calling an LLM](https://github.com/sjh9714/mergewarden)

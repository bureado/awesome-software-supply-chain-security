...
* [RomantiCode npm scope compromise checker](https://www.romanticode.com/tools/npm-scope-compromise-checker/) - Browser-based review checklist for package.json and lockfile snippets, scoped package changes, lifecycle scripts, registry sources, and AI coding agent supply-chain trust decisions.

...
* [Armada735/fake-star-audit: Dependency-free CLI/MCP tool that flags bot-inflated (fake) GitHub stars, returning a LOW/MEDIUM/HIGH risk verdict with per-rule evidence using only the anonymous GitHub API](https://github.com/Armada735/fake-star-audit)

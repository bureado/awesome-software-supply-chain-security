...
- [AI Code Guard](https://github.com/sarzho33-design/AI-CODE-GUARD): GitHub-native security gate for pull requests combining free deterministic checks (secrets, dangerous commands, injection patterns) with optional evidence-grounded AI review - every AI finding must cite an exact diff snippet or it's dropped before being shown.

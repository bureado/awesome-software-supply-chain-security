...
* [theinfosecguy/sloplock: CLI and GitHub Action that block nonexistent and newly published dependencies across npm, PyPI, Go, crates.io, Maven Central, NuGet.org, Packagist, and RubyGems.org](https://github.com/theinfosecguy/sloplock)

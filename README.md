...
* [pezhik/skilltotal: Offline static scanner that validates AI components (agent skills/plugins, MCP servers, npm & PyPI packages, repos) at point-of-use — deterministic regex + AST detection of dangerous capabilities, prompt-injection surfaces, MCP tool poisoning and exfiltration paths; JSON/SARIF output, zero runtime deps, no LLM](https://github.com/pezhik/skilltotal)
